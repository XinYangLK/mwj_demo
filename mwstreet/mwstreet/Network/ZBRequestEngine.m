...
//***  判断网络连接类型  **/
- (void)httpManagerLNetworkReachabilityManage {
    
    [[AFNetworkReachabilityManager sharedManager] startMonitoring];
    [[AFNetworkReachabilityManager sharedManager] setReachabilityStatusChangeBlock:^(AFNetworkReachabilityStatus status) {
        self->reachabilityStatus = status;
        switch (status) {
            case AFNetworkReachabilityStatusNotReachable: {//网络已断开
                NSLog(@"网络已断开");
                break;
            }
            case AFNetworkReachabilityStatusReachableViaWiFi:{//WiFi已连接
                 NSLog(@"WiFi已连接");
                break;
            }
            case AFNetworkReachabilityStatusReachableViaWWAN: {//数据网络连接
                 NSLog(@"数据网络连接");
                break;
            }
            default://不明网络

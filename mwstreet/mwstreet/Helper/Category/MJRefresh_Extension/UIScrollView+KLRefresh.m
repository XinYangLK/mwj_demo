...
@property (nonatomic, weak) id <KLMJRefreshDelegate> reDelegate;
...
- (void)setReDelegate:(id<KLMJRefreshDelegate>)reDelegate {
    
    objc_setAssociatedObject(self, &reDelegateKey, reDelegate, OBJC_ASSOCIATION_ASSIGN);
    
}
- (id<KLMJRefreshDelegate>)reDelegate {

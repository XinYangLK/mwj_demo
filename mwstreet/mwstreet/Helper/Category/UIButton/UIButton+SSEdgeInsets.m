...
- (void)setImagePositionWithType:(SSImagePositionType)type spacing:(CGFloat)spacing {
    ...
    [self setImagePositionWithType:type spacing:spacing margin:0];
}

- (void)setImagePositionWithType:(SSImagePositionType)type spacing:(CGFloat)spacing margin:(CGFloat)margin{
...
//            self.imageEdgeInsets = UIEdgeInsetsMake(- (titleSize.height + spacing), 0, 0, - (titleSize.width/2+titleSize.width/2/2-margin));
            break;
        }

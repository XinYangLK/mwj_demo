...
-(void)buildTags{
    ...
    for (int i = 0; i<_dataA.count; i++) {
        ...
        UIButton *button =[UIButton LXButtonNoFrameWithTitle:_dataA[i] titleFont:self.tagFont Image:nil backgroundImage:nil backgroundColor:[UIColor clearColor] titleColor:TextColor];
        [button setLayerCornerRadius:4 borderWidth:0.5 borderColor:LineColor];
        klWeakSelf;

//
//  KLBargainOrderManagerController.m
//  mwstreet
//
...
#import "KLBargainOrderManagerController.h"
#import "KLChildBargainOrderController.h"
@interface KLBargainOrderManagerController ()<
...
@implementation KLBargainOrderManagerController

- (NSMutableArray *)titleArray{
    if (!_titleArray) {
        _titleArray =[NSMutableArray arrayWithObjects:@"全部",@"砍价成功",@"砍价失败",@"失效商品",nil];
    }
    return _titleArray;
}
- (NSMutableAttributedString *)setTitle {
    return [self changeTitle:@"砍价订单"];
}
...
- (void)setupPageView {
    ...
    for (NSString * data in self.titleArray) {
        KLChildBargainOrderController *vc = [[KLChildBargainOrderController alloc]init];

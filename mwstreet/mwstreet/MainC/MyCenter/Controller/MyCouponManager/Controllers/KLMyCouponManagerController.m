...
#import "KLMyCouponManagerController.h"
#import "KLMyChildCouponListController.h"

@interface KLMyCouponManagerController ()<
...
@implementation KLMyCouponManagerController

- (NSMutableArray *)titleArray{
    if (!_titleArray) {
        _titleArray =[NSMutableArray arrayWithObjects:@"未使用",@"已失效",nil];
    }
    return _titleArray;
}
- (NSMutableAttributedString *)setTitle {
    return [self changeTitle:@"优惠券"];
}
...
//        KLMyChildCouponListController *vc = [[KLMyChildCouponListController alloc]init];

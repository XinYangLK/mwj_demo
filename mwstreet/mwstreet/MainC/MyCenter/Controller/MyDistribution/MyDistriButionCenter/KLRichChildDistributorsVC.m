...
@interface KLRichChildDistributorsVC ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;

@end

@implementation KLRichChildDistributorsVC
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        _tableView.mCustomFooterHeaderClass([KLRichChildDistributorsHeader class]);
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    KLRichChildDistributorsHeader *headerView  =kHeaderFooterIdentifier(KLRichChildDistributorsHeader)

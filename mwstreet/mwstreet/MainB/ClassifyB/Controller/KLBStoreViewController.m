...
#import "KLBStoreViewController.h"
...
@interface KLBStoreViewController ()
<
UITableViewDelegate,
...
@implementation KLBStoreViewController
...
- (KLNavigationSearchBtn *)searchBtn {
    ...
    if (!_searchBtn){
        ...
        CGFloat w = CGRectGetWidth(mainViewBounds)-AdaptedWidth(75);
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        CGFloat  h =  MainHeight - StatusBarAndNavigationBarHeight -AdaptedHeight(44) - TabbarHeight;
...
-(UICollectionReusableView*)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([kind isEqualToString:UICollectionElementKindSectionFooter]) {
        ...
        if (indexPath.section == 0) {
            [footerView.lookAllBtn setTitle:@"查看全部" forState:UIControlStateNormal];
        }else {
...
{
    if (section == 0) {
        return CGSizeMake(MainWidth-AdaptedWidth(95), AdaptedHeight(50));
